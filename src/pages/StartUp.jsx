...
function StartUp() {
  return (
    <>
      ...
      <div className="py-12 text-gray-300 font-montserrat text-[14px]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-green-600 font-Ubuntu sm:text-4xl">
              Pitch Your Startup
            </h2>
            ...
            <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <h4 className="text-xl font-bold text-gray-900">Pitching</h4>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <h4 className="text-xl font-bold text-gray-900">Placement</h4>
                  <p className="mt-2 text-base text-gray-500">
      ...
      <div className="bg-white text-center font-bold text-4xl">
        <h2 className="text-green-400">400</h2>
        <h2 className="text-green-500">500</h2>
        <h2 className="text-green-600">600</h2>
        <h2 className="text-green-700">700</h2>
        <h2 className="text-green-800">800</h2>
      </div>
    </>
  );
}
