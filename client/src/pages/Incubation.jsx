        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="">
            ...
            <div className="mt-5 text-center">
              <Link
                to="/register"
                className="inline-flex items-center justify-center px-5 py-3 border border-limeGreen rounded-tl-3xl rounded-br-3xl text-base font-medium text-white hover:bg-limeGreen"
              >
                Apply Now
              </Link>
            </div>
